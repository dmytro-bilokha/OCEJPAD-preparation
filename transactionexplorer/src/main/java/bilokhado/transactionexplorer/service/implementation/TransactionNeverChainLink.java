...
/**
 * ChainLink ejb with NEVER transaction attribute
 */
@Stateless
public class TransactionNeverChainLink extends AbstractChainLink {

    private static final Logger LOG = LoggerFactory.getLogger(TransactionNeverChainLink.class);
